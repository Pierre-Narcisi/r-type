...
namespace game {namespace system {
	void walls::updateDown() {
		if (_bindDown == (unsigned long)-1) {
			...
			ecs::Ecs::addComponent<ecs::component::Hitbox>(_bindDown, _bindDown, false, true/*, [](ID self, ID other){if (!ecs::Ecs::idHasComponents<game::component::wall>(other)){ecs::Ecs::deleteId(other);}}*/);
	...
	void walls::updateUp() {
		if (_bindUp == (unsigned long)-1) {
			...
			ecs::Ecs::addComponent<ecs::component::Hitbox>(_bindUp, _bindUp, false, true/*, [](ID self, ID other){if (!ecs::Ecs::idHasComponents<game::component::wall>(other)){ecs::Ecs::deleteId(other);}}*/);
